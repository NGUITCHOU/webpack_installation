...
sh
  cd weak 5/todo-list with ES6 and Webpack
  git clone https://github.com/NGUITCHOU/webpack_installation.git
...
## 👥 Authors <a name="Murielle"></a>

👤 Murielle Nguitchou
- GitHub: [@NGUITCHOU](https://github.com/NGUITCHOU/webpack_installation.git)
...
- Use of arrow functions and class
